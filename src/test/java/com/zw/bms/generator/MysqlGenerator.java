...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		strategy.setTablePrefix(new String[] { "bi_"});// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		//设置使得数据库字段强行按照java实体的骆驼式命名法大写字母前转化为下划线加小写的命名规范
//		strategy.setDbColumnUnderline(Boolean.TRUE);
		strategy.setInclude(new String[] {"bi_goods_info"}); // 需要生成的表
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.zw.bms.commons.base.BaseController");
		...
		pc.setParent("com.zw.bms"); // 自定义包路径
