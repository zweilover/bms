...
<!-- 用户自定义组件 -->
<script type="text/javascript" src="${staticPath }/static/easyui/jquery.easyui.extend.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticPath }/static/easyui/locale/easyui-lang-zh_CN.js" charset="utf-8"></script>
<!-- 读卡器插件 -->
<script type="text/javascript" src="${staticPath }/static/comm/TComm-mini.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticPath }/static/comm/TComm-utils.js" charset="utf-8"></script>
<%-- [扩展JS] --%>
<script type="text/javascript" src="${staticPath }/static/extJs.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticPath }/static/commons.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticPath }/static/json/json2.js" charset="utf-8"></script>
<%-- [ztree] --%>
