        ...
        <form id="userEditForm" method="post">
            ...
            <table class="grid">
                <tr>
                    ...
                    <input name="loginName" type="text" placeholder="请输入登录名称" class="easyui-validatebox" style="width: 140px" data-options="required:true" value="${user.loginName}" readonly="readonly"></td>
                    <td>姓名</td>
                    <td><input name="name" type="text" placeholder="请输入姓名" class="easyui-validatebox" style="width: 140px" data-options="required:true" value="${user.name}"></td>
                </tr>
                <tr>
                    <td>密码</td>
                    <td><input type="text" name="password" style="width: 140px" /></td>
                    <td>性别</td>
                ...
                <tr>
                    <td>年龄</td>
                    <td><input type="text" name="age" value="${user.age}" style="width: 140px" class="easyui-numberbox"/></td>
                    <td>用户类型</td>
                ...
                <tr>
                    <td>电话</td>
                    <td>
                        <input type="text" name="phone" class="easyui-numberbox" style="width: 140px" value="${user.phone}"/>
                    </td>
                    <td>用户类型</td>
                ...
                <tr>
                	<td>所属区域</td>
                	<td>
                		<select id="userEditLocation" name="location" style="width: 140px; height: 29px;" data-options="panelHeight:'auto'" class="easyui-combobox"></select>
						<a class="easyui-linkbutton" href="javascript:void(0)" onclick="$('#userEditLocation').combobox('setValue','');" >清空</a>
                	</td>
                </tr>
            </table>
        </form>
