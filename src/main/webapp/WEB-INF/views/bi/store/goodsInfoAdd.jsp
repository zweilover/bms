...
<script type="text/javascript">
    $(function() {
    	//所属区域下拉选项
    	$('#goodsInfoAdd_location').combobox({
        ...
        $('#goodsInfoAddForm').form({
            url : '${path}/store/goodsInfoAdd',
            onSubmit : function() {
                progressLoad();
        ...
        var localVal = $('#goodsInfoAdd_location').combobox("getValue");
		if(localVal != null && localVal != ""){
			$('#goodsInfoAdd_location').combobox({readonly: 'readonly'});
		}
    });
</script>
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="goodsInfoAddForm" method="post">
            <table class="grid">
                <tr>
                ...
                <tr>
                	...
                	<td>
                		<select id="goodsInfoAdd_location" name="location" style="width: 100px;" data-options="panelHeight:'auto'" class="easyui-combobox" required="required"></select>
                	</td>
                	<td>状态</td>
                	<td>
