package com.zw.bms.commons.scan;
...
import com.zw.bms.service.ISysLogService;
...
public class SysLogAspect {
    ...
    private boolean isWriteLog(String method) {
        String[] pattern = {"login", "logout", "add", "edit", "delete", "grant","deal","view","export","query","import"};
