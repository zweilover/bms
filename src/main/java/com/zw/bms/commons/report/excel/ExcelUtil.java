package com.zw.bms.commons.report.excel;
...
//        cellStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);
     ...
     * @throws IOException
     */
    public static ArrayList<ArrayList<String>> excelReader(String filePath) throws IOException{
    	boolean isExcel2007 = filePath.toLowerCase().endsWith("xlsx") ? true : false; //判断是否Excel2007
        Workbook wb = null;//读取xlsx文件
