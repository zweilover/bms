...
import com.zw.bms.mapper.ResourceMapper;
import com.zw.bms.mapper.RoleMapper;
import com.zw.bms.mapper.RoleResourceMapper;
import com.zw.bms.mapper.UserRoleMapper;
import com.zw.bms.model.Resource;
import com.zw.bms.service.IResourceService;
...
public class ResourceServiceImpl extends ServiceImpl<ResourceMapper, Resource> implements IResourceService {
    ...
    public List<Resource> selectByType(Integer type) {
        ...
        wrapper.addFilter("resource_type = {0} and status = {1}", type,0);
        wrapper.orderBy("seq");
        return resourceMapper.selectList(wrapper);
    }
