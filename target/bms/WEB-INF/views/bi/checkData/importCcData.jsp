...
<script type="text/javascript">
    $(function() {
        $('#importCcDataForm').form({
            url : '${path}/checkData/importCcDataExcel',
            onSubmit : function() {
                progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="importCcDataForm" method="post" enctype="multipart/form-data">
            <table class="grid">
                <tr>
                	<input type="hidden" name="type" value="CCIMP">
                    <td>出仓数据文件</td>
