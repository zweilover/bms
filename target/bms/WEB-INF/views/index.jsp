...
<body>
    ...
    <div id="index_layout">
            ...
            <div id="index_tabs" style="overflow: hidden;">
               <!-- 取消首页
                <div title="首页" data-options="iconCls:'fi-home',border:false" style="overflow: hidden;">
                    <script src='https://git.oschina.net/bms/spring-shiro-training/widget_preview'></script>
                    <style>
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2017 power by 孟家港集团<a href="http://www.mengjiagang.com/" target="_blank"></a></div>
    </div>
    <div id="tabsMenu">
